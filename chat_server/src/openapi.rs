use crate::{handlers::*, ChatFile, UpdateChat};
use crate::{
...
#[openapi(
        ...
        components(
            schemas(User, Chat,ChatFile,ChatType, ChatUser, Message, Workspace, SigninUser, CreateUser, CreateChat,UpdateChat, CreateMessage, ListMessages, AuthOutput, ErrorOutput),
        ),
